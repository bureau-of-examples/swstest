...
@XmlRootElement(name = "wsexampleFault")
public class WsexampleFault
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof WsexampleFault)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final WsexampleFault that = ((WsexampleFault) object);
        {
            String lhsMessage;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof WsexampleFault) {
            final WsexampleFault copy = ((WsexampleFault) draftCopy);
